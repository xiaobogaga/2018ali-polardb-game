...
/**
 * an external memory bplus tree implementation.
 * <p>
...
public class BPlusTree {
    ...
    // private static int LeafBlock = 160;
    // private static int MIDBlock = 144;
    // private static int LeafBlock = 64;
    // private static int MIDBlock = 48;
    ...
    public BPlusTree(String path, int cacheCpacity) throws IOException {
        ...
        System.err.println("creating a bplustree instance at "
                + this.PATH + " and mid_length_threshold : " +  this.MID_LENGTH_THRESHOLD
                + " , leaf_length_threshold : " + this.LEAF_LENGTH_THRESHOLD
                + " and root offset : " +  this.rootOffset + " , mid_size : " +
                this.current_mid_size + " , leaf_size : " + this.current_leaf_size);
    }
    ...
    public void close() {
        System.err.println("closing bplus tree");
